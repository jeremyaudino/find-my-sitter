...
class SittersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sitter" do
    assert_difference('Sitter.count') do
      post sitters_url, params: { sitter: { city: @sitter.city, first_name: @sitter.first_name, last_name: @sitter.last_name, mobile_number: @sitter.mobile_number, rate: @sitter.rate, state: @sitter.state } }
    end
  ...
  test "should update sitter" do
    patch sitter_url(@sitter), params: { sitter: { city: @sitter.city, first_name: @sitter.first_name, last_name: @sitter.last_name, mobile_number: @sitter.mobile_number, rate: @sitter.rate, state: @sitter.state } }
